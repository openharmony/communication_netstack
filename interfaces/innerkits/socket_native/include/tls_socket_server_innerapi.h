...
#ifndef COMMUNICATIONNETSTACK_TLS_SOCKET_SERVER_INNERAPI_H
#define COMMUNICATIONNETSTACK_TLS_SOCKET_SERVER_INNERAPI_H
...
using OnConnectCallback = std::function<void(const int &socketFd)>;
...
private:
    ...
    void CallOnConnectCallback(const int32_t socketFd);
    ...
    bool BindWithRetry(sockaddr *addr, socklen_t len, sockaddr_in *addr4, sockaddr_in6 *addr6,
...
#endif // COMMUNICATIONNETSTACK_TLS_SOCKET_SERVER_INNERAPI_H
