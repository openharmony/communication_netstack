...
#ifndef COMMUNICATIONNETSTACK_TLS_SOCKET_CLIENT_INNERAPI_H
#define COMMUNICATIONNETSTACK_TLS_SOCKET_CLIENT_INNERAPI_H
...
#endif // COMMUNICATION_NETSTACK_TLS_CLIENT_INNERAPI_H
