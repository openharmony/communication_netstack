...
namespace OHOS::NetStack::Websocket
{
    ...
    bool ServerCloseContext::IsValidWebsocketConnection(napi_env env, napi_value params)
    {
        ...
        return (NapiUtils::GetValueType(env, NapiUtils::GetNamedProperty(env, params, ContextKey::CLIENT_PORT)) == napi_number) && (NapiUtils::GetValueType(env, NapiUtils::GetNamedProperty(env, params,
                                                                                                                                                                                             ContextKey::CLIENT_IP)) == napi_string);
    }
    ...
    bool ServerCloseContext::IsValidCloseOptions(napi_env env, napi_value params)
    {
        ...
        return NapiUtils::GetValueType(env, NapiUtils::GetNamedProperty(env, params, ContextKey::CODE)) == napi_number &&
               NapiUtils::GetValueType(env, NapiUtils::GetNamedProperty(env, params, ContextKey::REASON)) == napi_string;
    }
