...
{
    napi_env env = GetEnv();
    int32_t from = NapiUtils::GetInt32Property(env, optionsValue, HttpConstant::PARAM_KEY_RESUME_FROM);
    int32_t to = NapiUtils::GetInt32Property(env, optionsValue, HttpConstant::PARAM_KEY_RESUME_TO);
