...
static const std::map<int32_t, const char *> HTTP_ERR_MAP = {
    ...
    {static_cast<int32_t>(HttpErrorCode::HTTP_WRITE_ERROR), "Failed to write the received data to the disk or application."},
    {static_cast<int32_t>(HttpErrorCode::HTTP_UPLOAD_FAILED), "Upload failed."},
    {static_cast<int32_t>(HttpErrorCode::HTTP_READ_ERROR), "Failed to open or read local data from the file or application."},
    ...
    {static_cast<int32_t>(HttpErrorCode::HTTP_TOO_MANY_REDIRECTS), "The number of redirections reaches the maximum allowed."},
