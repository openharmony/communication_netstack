...
static constexpr int32_t SOCKET_ERROR_OK = 0;
static constexpr int32_t UNKNOWN_ERROR = -1;
static constexpr int32_t PERMISSION_DENIED_CODE = 201;
static constexpr const char *PERMISSION_DENIED_MSG = "Permission denied";
static constexpr int32_t PARAM_ERROR_CODE = 401;
static constexpr const char *PARAM_ERROR_MSG = "Parameter error";
static constexpr int32_t SOCKS5_ERROR_CODE = 205;
static constexpr int32_t ERRNO_BAD_FD = 9;
static constexpr int32_t SYSTEM_INTERNAL_ERROR = 2300002;
constexpr const char *SYSTEM_INTERNAL_ERROR_MSG = "System internal error";
static constexpr int32_t SOCKET_FD_INVALID_CODE = 2300999;
