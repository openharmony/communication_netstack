...
int TLSSocketServer::RecvRemoteInfo(int socketFd, int clientid)
{
    {
        std::lock_guard<std::mutex> its_lock(connectMutex_);
        for (auto it = connections_.begin(); it != connections_.end();) {
             ...
             namespace OHOS
{
    ...
    void TLSSocketServer::ExecAccept(const TlsSocket::TLSConnectOptions &tlsAcceptOptions,
    ...
    void TLSSocketServer::GetRemoteCertificate(const int socketFd,
                                               const TlsSocket::GetRemoteCertificateCallback &callback)
    {
    }
    ...
    bool TLSSocketServer::Connection::TlsAcceptToHost(int sock, const TlsSocket::TLSConnectOptions &options)
    {
        ...
        connectionConfiguration_.SetVerifyMode(options.GetTlsSecureOptions().GetVerifyMode());
        NETSTACK_LOGI(
            "TLSSocketServer::Connection::TlsAcceptToHost  connectionConfiguration_GetVerifyMode() :%{public}d",
